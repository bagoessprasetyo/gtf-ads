...
export default function TailoredIdPage() {
  ...
  const cards = [
    ...
    { img: dore, title: "DORE", content: "IDR 30 Miliar Pipeline B2B Baru" },
    { img: ikigai, title: "IKIGAI", content: "700+ Anggota Baru Setiap Bulannya" },
  ];
  ...
  return (
    <main>
      <Banner
        ...
        btnName="Konsultasi dengan Tim Kami"
      />
      ...
      <section className="py-14 bg-white px-5 lg:py-[60px] lg:px-20">
        <div className="bg-[#140018] rounded-[12px] py-4 px-6 lg:p-8">
          <h2 className="text-white text-2xl leading-8 font-semibold lg:text-5xl">
            Hasil Terbukti di Berbagai Industri
          </h2>
          <p className="text-[#E4E7EC] tracking-[0.08px] my-6">
            Kami ubah tantangan pertumbuhan menjadi hasil yang nyara bagi klien kami.
          </p>
          <Button link="#tailored-form-id" title="Hubungi Kami" className="lg:hidden" />
          <Button link="#tailored-form-id" title="Konsultasi dengan Tim Kami" className="hidden lg:flex" />
      ...
      <section className="bg-[#F2F4F7] py-12 px-5 lg:py-20 lg:px-[120px]">
        <div className="flex flex-col gap-12 md:grid md:grid-cols-2 md:items-center lg:gap-20">
          <div className="md:order-2">
            <h2 className="text-[#141C25] text-2xl font-semibold leading-8 lg:text-5xl lg:leading-14">
              Kami Memberikan Pertumbuhan Yang Terukur, Bukan Sekadar Klik
            </h2>
            <p className="text-[#414E62] tracking-[0.08px] mt-3">
              Kami menyatukan strategi, kreatif, teknologi, dan data dalam satu sistem growth marketing yang menghasilkan konversi. Setiap langkah, dari awareness hingga revenue, kami menggabungkan strategi marketing dengan dukungan data untuk menghasilkan pertumbuhan bisnis.
            </p>
            <Button link="#tailored-form-id" title="Konsultasi dengan Tim Kami" className="hidden lg:flex mt-6" />
          </div>
      ...
      {/* Contact */}
      <section className="bg-white py-14 px-5 lg:py-20 lg:px-60" id="tailored-form-id">
